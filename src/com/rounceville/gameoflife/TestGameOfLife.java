...
public class TestGameOfLife {
	...
	@Test
	public void testAnyLiveCellWithTwoOrThreeLiveNeighborsLivesOnToTheNextGenerationTest3() {
		GridMatrix gm = new GridMatrix(3,4);
		gm.setAt(0, 0, true);	
		gm.setAt(1, 0, true);
		gm.setAt(2, 0, true);
	...
	@Test
	public void testAnyLiveCellWithTwoOrThreeLiveNeighborsLivesOnToTheNextGenerationTest4() {
		GridMatrix gm = new GridMatrix(3,4);
		gm.setAt(0, 0, true);	
		gm.setAt(1, 0, true);
		gm.setAt(2, 0, true);
	...
	public void testAnyLiveCellWithTwoOrThreeLiveNeighborsLivesOnToTheNextGenerationTest8() {
		...
		assertEquals(false, gm2.getAt(1, 0));
		assertEquals(true,  gm2.getAt(2, 0));
		assertEquals(false, gm2.getAt(0, 1));		
		assertEquals(false, gm2.getAt(1, 1));		
